...
public class RNWebGLViewShotModule extends ReactContextBaseJavaModule {

    private final ReactApplicationContext reactContext;

    public RNWebGLViewShotModule(ReactApplicationContext reactContext) {
        super(reactContext);
